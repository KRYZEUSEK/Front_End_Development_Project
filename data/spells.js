const SPELLS = {
  wizard: {
    0: ["Fire Bolt", "Light", "Mage Hand", "Prestidigitation", "Ray of Frost", "Minor Illusion"],
    1: ["Magic Missile", "Shield", "Sleep", "Mage Armor", "Detect Magic", "Burning Hands"],
    2: ["Mirror Image", "Misty Step", "Hold Person", "Scorching Ray", "Invisibility", "Levitate"],
    3: ["Counterspell", "Fireball", "Fly", "Dispel Magic", "Haste", "Lightning Bolt"],
    4: ["Greater Invisibility", "Polymorph", "Ice Storm", "Dimension Door", "Stoneskin"],
    5: ["Wall of Force", "Teleportation Circle", "Cone of Cold", "Cloudkill", "Animate Objects"],
  ...
  cleric: {
    ...
    1: ["Cure Wounds", "Bless", "Shield of Faith", "Command", "Detect Magic", "Inflict Wounds"],
    2: ["Spiritual Weapon", "Hold Person", "Lesser Restoration", "Enhance Ability", "Aid"],
    3: ["Dispel Magic", "Spirit Guardians", "Mass Healing Word", "Revivify", "Beacon of Hope"],
    4: ["Freedom of Movement", "Guardian of Faith", "Divination", "Death Ward"],
    5: ["Raise Dead", "Flame Strike", "Mass Cure Wounds", "Dispel Evil and Good"],
  ...
  druid: {
    ...
    1: ["Entangle", "Goodberry", "Cure Wounds", "Faerie Fire", "Thunderwave"],
    2: ["Moonbeam", "Flaming Sphere", "Hold Person", "Pass without Trace", "Spike Growth"],
    3: ["Call Lightning", "Plant Growth", "Wind Wall", "Water Breathing", "Dispel Magic"],
    4: ["Ice Storm", "Stoneskin", "Greater Invisibility", "Freedom of Movement"],
    5: ["Wall of Stone", "Commune with Nature", "Tree Stride", "Reincarnate"],
  ...
  bard: {
    ...
    1: ["Healing Word", "Charm Person", "Detect Magic", "Dissonant Whispers", "Faerie Fire"],
    2: ["Enhance Ability", "Invisibility", "Hold Person", "Mirror Image", "Suggestion"],
    3: ["Hypnotic Pattern", "Dispel Magic", "Leomund's Tiny Hut", "Major Image"],
  ...
  sorcerer: {
    0: ["Fire Bolt", "Light", "Mage Hand", "Prestidigitation", "Ray of Frost"],
    1: ["Shield", "Magic Missile", "Mage Armor", "Burning Hands", "Chromatic Orb"],
    2: ["Mirror Image", "Misty Step", "Hold Person", "Scorching Ray", "Invisibility"],
    3: ["Fireball", "Counterspell", "Fly", "Haste", "Lightning Bolt"],
    4: ["Greater Invisibility", "Polymorph", "Ice Storm", "Dimension Door"],
    5: ["Wall of Force", "Teleportation Circle", "Cone of Cold", "Animate Objects"],
