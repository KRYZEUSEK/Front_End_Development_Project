...
const SPELLS_TASHA = {
  wizard: {
    ...
    1: ["Absorb Elements", "Acid Stream (UA)", "Alarm", "Burning Hands", "Catapult", "Cause Fear", "Charm Person", "Chromatic Orb", "Color Spray", "Comprehend Languages", "Detect Magic", "Disguise Self", "Distort Value", "Earth Tremor", "Expeditious Retreat", "False Life", "Feather Fall", "Find Familiar", "Fog Cloud", "Frost Fingers", "Gift of Alacrity", "Grease", "Guiding Hand (UA)", "Healing Elixir (UA)", "Ice Knife", "Id Insinuation (UA)", "Identify", "Illusory Script", "Infallible Relay (UA)", "Jim's Magic Missile", "Jump", "Longstrider", "Mage Armor", "Magic Missile", "Magnify Gravity", "Protection from Evil and Good", "Puppet (UA)", "Ray of Sickness", "Remote Access (UA)", "Sense Emotion (UA)", "Shield", "Silent Image", "Silvery Barbs", "Sleep", "Snare", "Sudden Awakening (UA)", "Tasha's Caustic Brew", "Tasha's Hideous Laughter", "Tenser's Floating Disk", "Thunderwave", "Unseen Servant", "Witch Bolt"],
    2: ["Aganazzar's Scorcher", "Air Bubble", "Alter Self", "Arcane Hacking (UA)", "Arcane Lock", "Augury", "Blindness/Deafness", "Blur", "Borrowed Knowledge", "Cloud of Daggers", "Continual Flame", "Crown of Madness", "Darkness", "Darkvision", "Detect Thoughts", "Digital Phantom (UA)", "Dragon's Breath", "Dust Devil", "Earthbind", "Enhance Ability", "Enlarge/Reduce", "Find Vehicle (UA)", "Flaming Sphere", "Flock of Familiars", "Fortune's Favor", "Gentle Repose", "Gift of Gab", "Gust of Wind", "Hold Person", "Icingdeath's Frost (UA)", "Immovable Object", "Invisibility", "Jim's Glowing Coin", "Kinetic Jaunt", "Knock", "Levitate", "Locate Object", "Magic Mouth", "Magic Weapon", "Maximillian's Earthen Grasp", "Melf's Acid Arrow", "Mental Barrier (UA)", "Mind Spike", "Mind Thrust (UA)", "Mirror Image", "Misty Step", "Nathair's Mischief", "Nathair's Mischief (UA)", "Nystul's Magic Aura", "Phantasmal Force", "Pyrotechnics", "Ray of Enfeeblement", "Rime's Binding Ice", "Rope Trick", "Scorching Ray", "See Invisibility", "Shadow Blade", "Shatter", "Skywrite", "Snilloc's Snowball Swarm", "Spider Climb", "Spray Of Cards", "Spray of Cards (UA)", "Suggestion", "Tasha's Mind Whip", "Thought Shield (UA)", "Vortex Warp", "Warding Wind", "Warp Sense", "Web", "Wither and Bloom", "Wristpocket"],
    3: ["Animate Dead", "Antagonize", "Antagonize (UA)", "Ashardalon's Stride", "Bestow Curse", "Blink", "Catnap", "Clairvoyance", "Conjure Lesser Demon (UA)", "Counterspell", "Dispel Magic", "Enemies Abound", "Erupting Earth", "Fast Friends", "Fear", "Feign Death", "Fireball", "Flame Arrows", "Flame Stride (UA)", "Fly", "Galder's Tower", "Gaseous Form", "Glyph of Warding", "Haste", "Haywire (UA)", "House of Cards (UA)", "Hypnotic Pattern", "Incite Greed", "Intellect Fortress", "Invisibility To Cameras (UA)", "Leomund's Tiny Hut", "Life Transference", "Lightning Bolt", "Magic Circle", "Major Image", "Melf's Minute Meteors", "Nondetection", "Phantom Steed", "Protection from Ballistics (UA)", "Protection from Energy", "Psionic Blast (UA)", "Pulse Wave", "Remove Curse", "Sending", "Sleet Storm", "Slow", "Speak with Dead", "Spirit Shroud", "Stinking Cloud", "Summon Fey", "Summon Lesser Demons", "Summon Shadowspawn", "Summon Undead", "Summon Warrior Spirit (UA)", "Thunder Step", "Tidal Wave", "Tiny Servant", "Tongues", "Vampiric Touch", "Wall of Sand", "Wall of Water", "Water Breathing"],
    4: ["Arcane Eye", "Banishment", "Blight", "Charm Monster", "Confusion", "Conjure Barlgura (UA)", "Conjure Knowbot (UA)", "Conjure Minor Elementals", "Conjure Shadow Demon (UA)", "Control Water", "Dimension Door", "Divination", "Ego Whip (UA)", "Elemental Bane", "Evard's Black Tentacles", "Fabricate", "Fire Shield", "Galder's Speedy Courier", "Gate Seal", "Gravity Sinkhole", "Greater Invisibility", "Hallucinatory Terrain", "Ice Storm", "Leomund's Secret Chest", "Locate Creature", "Mordenkainen's Faithful Hound", "Mordenkainen's Private Sanctum", "Otiluke's Resilient Sphere", "Phantasmal Killer", "Polymorph", "Raulothim's Psychic Lance", "Raulothim's Psychic Lance (UA)", "Sickening Radiance", "Spirit Of Death", "Spirit of Death (UA)", "Stone Shape", "Stoneskin", "Storm Sphere", "Summon Aberration", "Summon Construct", "Summon Elemental", "Summon Greater Demon", "Synchronicity (UA)", "System Backdoor (UA)", "Vitriolic Sphere", "Wall of Fire", "Watery Sphere"],
    5: ["Animate Objects", "Bigby's Hand", "Cloudkill", "Commune with City (UA)", "Cone of Cold", "Conjure Elemental", "Conjure Vrock (UA)", "Contact Other Plane", "Control Winds", "Create Spelljamming Helm", "Creation", "Danse Macabre", "Dawn", "Dominate Person", "Dream", "Enervation", "Far Step", "Geas", "Hold Monster", "Immolation", "Infernal Calling", "Legend Lore", "Mislead", "Modify Memory", "Negative Energy Flood", "Passwall", "Planar Binding", "Rary's Telepathic Bond", "Scrying", "Seeming", "Shutdown (UA)", "Skill Empowerment", "Steel Wind Strike", "Summon Draconic Spirit", "Summon Draconic Spirit (UA)", "Synaptic Static", "Telekinesis", "Teleportation Circle", "Temporal Shunt", "Transmute Rock", "Wall of Force", "Wall of Light", "Wall of Stone"],
    6: ["Arcane Gate", "Chain Lightning", "Circle of Death", "Contingency", "Create Homunculus", "Create Undead", "Disintegrate", "Drawmij's Instant Summons", "Eyebite", "Fizban's Platinum Shield", "Fizban's Platinum Shield (UA)", "Flesh to Stone", "Globe of Invulnerability", "Gravity Fissure", "Guards and Wards", "Investiture of Flame", "Investiture of Ice", "Investiture of Stone", "Investiture of Wind", "Magic Jar", "Mass Suggestion", "Mental Prison", "Move Earth", "Otherworldly Form (UA)", "Otiluke's Freezing Sphere", "Otto's Irresistible Dance", "Programmed Illusion", "Psychic Crush (UA)", "Scatter", "Soul Cage", "Summon Fiend", "Sunbeam", "Tasha's Otherworldly Guise", "Tenser's Transformation", "True Seeing", "Wall of Ice"],
    7: ["Conjure Hezrou (UA)", "Create Magen", "Crown of Stars", "Delayed Blast Fireball", "Draconic Transformation", "Draconic Transformation (UA)", "Dream of the Blue Veil", "Etherealness", "Finger of Death", "Forcecage", "Mirage Arcane", "Mordenkainen's Magnificent Mansion", "Mordenkainen's Sword", "Plane Shift", "Power Word: Pain", "Prismatic Spray", "Project Image", "Reverse Gravity", "Sequester", "Simulacrum", "Symbol", "Teleport", "Tether Essence", "Whirlwind"],
    8: ["Abi-Dalzim's Horrid Wilting", "Antimagic Field", "Antipathy/Sympathy", "Clone", "Control Weather", "Dark Star", "Demiplane", "Dominate Monster", "Feeblemind", "Illusory Dragon", "Incendiary Cloud", "Maddening Darkness", "Maze", "Mighty Fortress", "Mind Blank", "Power Word: Stun", "Reality Break", "Sunburst", "Telepathy"],
  ...
  cleric: {
    0: ["Guidance", "Hand of Radiance (UA)", "Light", "Mending", "Resistance", "Sacred Flame", "Spare the Dying", "Thaumaturgy", "Toll the Dead", "Virtue (UA)", "Word of Radiance"],
    1: ["Bane", "Bless", "Ceremony", "Command", "Create or Destroy Water", "Cure Wounds", "Detect Evil and Good", "Detect Magic", "Detect Poison and Disease", "Guiding Bolt", "Guiding Hand (UA)", "Healing Word", "Inflict Wounds", "Protection from Evil and Good", "Purify Food and Drink", "Sanctuary", "Shield of Faith"],
    2: ["Aid", "Augury", "Blindness/Deafness", "Borrowed Knowledge", "Calm Emotions", "Continual Flame", "Enhance Ability", "Find Traps", "Gentle Repose", "Hold Person", "Lesser Restoration", "Locate Object", "Prayer of Healing", "Protection from Poison", "Silence", "Spiritual Weapon", "Warding Bond", "Zone of Truth"],
    3: ["Animate Dead", "Aura of Vitality", "Beacon of Hope", "Bestow Curse", "Clairvoyance", "Create Food and Water", "Daylight", "Dispel Magic", "Fast Friends", "Feign Death", "Glyph of Warding", "Incite Greed", "Life Transference", "Magic Circle", "Mass Healing Word", "Meld into Stone", "Motivational Speech", "Protection from Energy", "Remove Curse", "Revivify", "Sending", "Speak with Dead", "Spirit Guardians", "Spirit Shroud", "Tongues", "Water Walk"],
    ...
    6: ["Blade Barrier", "Create Undead", "Find the Path", "Forbiddance", "Harm", "Heal", "Heroes' Feast", "Otherworldly Form (UA)", "Planar Ally", "Sunbeam", "True Seeing", "Word of Recall"],
    7: ["Conjure Celestial", "Divine Word", "Etherealness", "Fire Storm", "Plane Shift", "Regenerate", "Resurrection", "Symbol", "Temple of the Gods"],
  ...
  druid: {
    ...
    5: ["Antilife Shell", "Awaken", "Commune with Nature", "Cone of Cold", "Conjure Elemental", "Contagion", "Control Winds", "Geas", "Greater Restoration", "Insect Plague", "Maelstrom", "Mass Cure Wounds", "Planar Binding", "Reincarnate", "Scrying", "Summon Draconic Spirit", "Summon Draconic Spirit (UA)", "Transmute Rock", "Tree Stride", "Wall of Stone", "Wrath Of Nature"],
    ...
    7: ["Draconic Transformation", "Draconic Transformation (UA)", "Fire Storm", "Mirage Arcane", "Plane Shift", "Regenerate", "Reverse Gravity", "Symbol", "Whirlwind"],
  ...
  bard: {
    0: ["Blade Ward", "Dancing Lights", "Friends", "Light", "Mage Hand", "Mending", "Message", "Minor Illusion", "Prestidigitation", "Thunderclap", "True Strike", "Vicious Mockery"],
    1: ["Animal Friendship", "Bane", "Charm Person", "Color Spray", "Command", "Comprehend Languages", "Cure Wounds", "Detect Magic", "Disguise Self", "Dissonant Whispers", "Distort Value", "Earth Tremor", "Faerie Fire", "Feather Fall", "Guiding Hand (UA)", "Healing Word", "Heroism", "Identify", "Illusory Script", "Longstrider", "Puppet (UA)", "Sense Emotion (UA)", "Silent Image", "Silvery Barbs", "Sleep", "Speak with Animals", "Sudden Awakening (UA)", "Tasha's Hideous Laughter", "Thunderwave", "Unearthly Chorus (UA)", "Unseen Servant"],
    2: ["Aid", "Animal Messenger", "Blindness/Deafness", "Borrowed Knowledge", "Calm Emotions", "Cloud of Daggers", "Crown of Madness", "Detect Thoughts", "Enhance Ability", "Enlarge/Reduce", "Enthrall", "Gift of Gab", "Heat Metal", "Hold Person", "Invisibility", "Kinetic Jaunt", "Knock", "Lesser Restoration", "Locate Animals or Plants", "Locate Object", "Magic Mouth", "Mirror Image", "Nathair's Mischief", "Nathair's Mischief (UA)", "Phantasmal Force", "Pyrotechnics", "See Invisibility", "Shatter", "Silence", "Skywrite", "Spray Of Cards", "Spray of Cards (UA)", "Suggestion", "Warding Wind", "Zone of Truth"],
    3: ["Antagonize", "Antagonize (UA)", "Bestow Curse", "Catnap", "Clairvoyance", "Dispel Magic", "Enemies Abound", "Fast Friends", "Fear", "Feign Death", "Glyph of Warding", "House of Cards (UA)", "Hypnotic Pattern", "Intellect Fortress", "Leomund's Tiny Hut", "Major Image", "Mass Healing Word", "Motivational Speech", "Nondetection", "Plant Growth", "Sending", "Slow", "Speak with Dead", "Speak with Plants", "Stinking Cloud", "Tongues"],
    4: ["Charm Monster", "Compulsion", "Confusion", "Dimension Door", "Ego Whip (UA)", "Freedom of Movement", "Greater Invisibility", "Hallucinatory Terrain", "Locate Creature", "Phantasmal Killer", "Polymorph", "Raulothim's Psychic Lance", "Raulothim's Psychic Lance (UA)"],
  ...
  sorcerer: {
    ...
    1: ["Absorb Elements", "Acid Stream (UA)", "Burning Hands", "Catapult", "Chaos Bolt", "Charm Person", "Chromatic Orb", "Color Spray", "Comprehend Languages", "Detect Magic", "Disguise Self", "Distort Value", "Earth Tremor", "Expeditious Retreat", "False Life", "Feather Fall", "Fog Cloud", "Grease", "Ice Knife", "Id Insinuation (UA)", "Infallible Relay (UA)", "Jump", "Mage Armor", "Magic Missile", "Ray of Sickness", "Remote Access (UA)", "Shield", "Silent Image", "Silvery Barbs", "Sleep", "Sudden Awakening (UA)", "Tasha's Caustic Brew", "Thunderwave", "Witch Bolt"],
    2: ["Aganazzar's Scorcher", "Air Bubble", "Alter Self", "Arcane Hacking (UA)", "Blindness/Deafness", "Blur", "Cloud of Daggers", "Crown of Madness", "Darkness", "Darkvision", "Detect Thoughts", "Digital Phantom (UA)", "Dragon's Breath", "Dust Devil", "Earthbind", "Enhance Ability", "Enlarge/Reduce", "Find Vehicle (UA)", "Flame Blade", "Flaming Sphere", "Gust of Wind", "Hold Person", "Icingdeath's Frost (UA)", "Invisibility", "Kinetic Jaunt", "Knock", "Levitate", "Magic Weapon", "Maximillian's Earthen Grasp", "Mental Barrier (UA)", "Mind Spike", "Mind Thrust (UA)", "Mirror Image", "Misty Step", "Nathair's Mischief", "Nathair's Mischief (UA)", "Phantasmal Force", "Pyrotechnics", "Rime's Binding Ice", "Scorching Ray", "See Invisibility", "Shadow Blade", "Shatter", "Snilloc's Snowball Swarm", "Spider Climb", "Spray Of Cards", "Spray of Cards (UA)", "Suggestion", "Tasha's Mind Whip", "Thought Shield (UA)", "Vortex Warp", "Warding Wind", "Warp Sense", "Web", "Wither and Bloom"],
    3: ["Antagonize", "Antagonize (UA)", "Ashardalon's Stride", "Blink", "Catnap", "Clairvoyance", "Conjure Lesser Demon (UA)", "Counterspell", "Daylight", "Dispel Magic", "Enemies Abound", "Erupting Earth", "Fear", "Fireball", "Flame Arrows", "Flame Stride (UA)", "Fly", "Gaseous Form", "Haste", "Haywire (UA)", "House of Cards (UA)", "Hypnotic Pattern", "Incite Greed", "Intellect Fortress", "Invisibility To Cameras (UA)", "Lightning Bolt", "Major Image", "Melf's Minute Meteors", "Protection from Ballistics (UA)", "Protection from Energy", "Psionic Blast (UA)", "Sleet Storm", "Slow", "Stinking Cloud", "Summon Warrior Spirit (UA)", "Thunder Step", "Tidal Wave", "Tongues", "Vampiric Touch", "Wall of Water", "Water Breathing", "Water Walk"],
    4: ["Banishment", "Blight", "Charm Monster", "Confusion", "Conjure Barlgura (UA)", "Conjure Knowbot (UA)", "Conjure Shadow Demon (UA)", "Dimension Door", "Dominate Beast", "Ego Whip (UA)", "Fire Shield", "Gate Seal", "Greater Invisibility", "Ice Storm", "Polymorph", "Raulothim's Psychic Lance", "Raulothim's Psychic Lance (UA)", "Sickening Radiance", "Spirit Of Death", "Spirit of Death (UA)", "Stoneskin", "Storm Sphere", "Synchronicity (UA)", "System Backdoor (UA)", "Vitriolic Sphere", "Wall of Fire", "Watery Sphere"],
    5: ["Animate Objects", "Bigby's Hand", "Cloudkill", "Commune with City (UA)", "Cone of Cold", "Conjure Vrock (UA)", "Control Winds", "Creation", "Dominate Person", "Enervation", "Far Step", "Hold Monster", "Immolation", "Insect Plague", "Seeming", "Shutdown (UA)", "Skill Empowerment", "Summon Draconic Spirit", "Summon Draconic Spirit (UA)", "Synaptic Static", "Telekinesis", "Teleportation Circle", "Wall of Light", "Wall of Stone"],
    6: ["Arcane Gate", "Chain Lightning", "Circle of Death", "Disintegrate", "Eyebite", "Fizban's Platinum Shield", "Fizban's Platinum Shield (UA)", "Flesh to Stone", "Globe of Invulnerability", "Investiture of Flame", "Investiture of Ice", "Investiture of Stone", "Investiture of Wind", "Mass Suggestion", "Mental Prison", "Move Earth", "Otherworldly Form (UA)", "Otiluke's Freezing Sphere", "Psychic Crush (UA)", "Scatter", "Sunbeam", "Tasha's Otherworldly Guise", "True Seeing"],
    7: ["Conjure Hezrou (UA)", "Crown of Stars", "Delayed Blast Fireball", "Draconic Transformation", "Draconic Transformation (UA)", "Dream of the Blue Veil", "Etherealness", "Finger of Death", "Fire Storm", "Plane Shift", "Power Word: Pain", "Prismatic Spray", "Reverse Gravity", "Teleport"],
    8: ["Abi-Dalzim's Horrid Wilting", "Demiplane", "Dominate Monster", "Earthquake", "Incendiary Cloud", "Power Word: Stun", "Sunburst"],
    9: ["Blade of Disaster", "Gate", "Mass Polymorph", "Meteor Swarm", "Power Word: Kill", "Psychic Scream", "Time Stop", "Wish"]
  },

  warlock: {
    0: ["Blade Ward", "Booming Blade", "Chill Touch", "Create Bonfire", "Eldritch Blast", "Friends", "Frostbite", "Green-Flame Blade", "Infestation", "Lightning Lure", "Mage Hand", "Magic Stone", "Mind Sliver", "Minor Illusion", "On/Off (UA)", "Poison Spray", "Prestidigitation", "Sword Burst", "Thunderclap", "Toll the Dead", "True Strike"],
    1: ["Armor of Agathys", "Arms of Hadar", "Cause Fear", "Charm Person", "Comprehend Languages", "Distort Value", "Expeditious Retreat", "Healing Elixir (UA)", "Hellish Rebuke", "Hex", "Id Insinuation (UA)", "Illusory Script", "Infallible Relay (UA)", "Protection from Evil and Good", "Puppet (UA)", "Remote Access (UA)", "Sense Emotion (UA)", "Unseen Servant", "Witch Bolt"],
    2: ["Arcane Hacking (UA)", "Borrowed Knowledge", "Cloud of Daggers", "Crown of Madness", "Darkness", "Digital Phantom (UA)", "Earthbind", "Enthrall", "Find Vehicle (UA)", "Flock of Familiars", "Hold Person", "Invisibility", "Mental Barrier (UA)", "Mind Spike", "Mind Thrust (UA)", "Mirror Image", "Misty Step", "Ray of Enfeeblement", "Shadow Blade", "Shatter", "Spider Climb", "Spray Of Cards", "Spray of Cards (UA)", "Suggestion", "Thought Shield (UA)", "Warp Sense"],
    3: ["Antagonize", "Antagonize (UA)", "Counterspell", "Dispel Magic", "Enemies Abound", "Fear", "Fly", "Gaseous Form", "Haywire (UA)", "Hunger Of Hadar", "Hypnotic Pattern", "Incite Greed", "Intellect Fortress", "Invisibility To Cameras (UA)", "Magic Circle", "Major Image", "Protection from Ballistics (UA)", "Psionic Blast (UA)", "Remove Curse", "Spirit Shroud", "Summon Fey", "Summon Lesser Demons", "Summon Shadowspawn", "Summon Undead", "Summon Warrior Spirit (UA)", "Thunder Step", "Tongues", "Vampiric Touch"],
    4: ["Banishment", "Blight", "Charm Monster", "Conjure Knowbot (UA)", "Dimension Door", "Ego Whip (UA)", "Elemental Bane", "Galder's Speedy Courier", "Gate Seal", "Hallucinatory Terrain", "Raulothim's Psychic Lance", "Raulothim's Psychic Lance (UA)", "Shadow Of Moil", "Sickening Radiance", "Spirit Of Death", "Spirit of Death (UA)", "Summon Aberration", "Summon Greater Demon", "Synchronicity (UA)", "System Backdoor (UA)"],
    5: ["Commune with City (UA)", "Contact Other Plane", "Danse Macabre", "Dream", "Enervation", "Far Step", "Hold Monster", "Infernal Calling", "Mislead", "Negative Energy Flood", "Planar Binding", "Scrying", "Shutdown (UA)", "Synaptic Static", "Teleportation Circle", "Wall of Light"],
    6: ["Arcane Gate", "Circle of Death", "Conjure Fey", "Create Undead", "Eyebite", "Flesh to Stone", "Investiture of Flame", "Investiture of Ice", "Investiture of Stone", "Investiture of Wind", "Mass Suggestion", "Mental Prison", "Otherworldly Form (UA)", "Psychic Crush (UA)", "Scatter", "Soul Cage", "Summon Fiend", "Tasha's Otherworldly Guise", "True Seeing"],
  ...
  paladin: {
    1: ["Bless", "Ceremony", "Command", "Compelled Duel", "Cure Wounds", "Detect Evil and Good", "Detect Magic", "Detect Poison and Disease", "Divine Favor", "Heroism", "Protection from Evil and Good", "Purify Food and Drink", "Searing Smite", "Shield of Faith", "Thunderous Smite", "Wrathful Smite"],
    2: ["Aid", "Branding Smite", "Find Steed", "Find Vehicle (UA)", "Gentle Repose", "Lesser Restoration", "Locate Object", "Magic Weapon", "Prayer of Healing", "Protection from Poison", "Warding Bond", "Zone of Truth"],
  ...
  ranger: {
    1: ["Absorb Elements", "Alarm", "Animal Friendship", "Beast Bond", "Cure Wounds", "Detect Magic", "Detect Poison and Disease", "Ensnaring Strike", "Entangle", "Fog Cloud", "Goodberry", "Hail of Thorns", "Hunter's Mark", "Jump", "Longstrider", "Searing Smite", "Snare", "Speak with Animals", "Sudden Awakening (UA)", "Wild Cunning (UA)", "Zephyr Strike"],
    2: ["Aid", "Air Bubble", "Animal Messenger", "Barkskin", "Beast Sense", "Cordon of Arrows", "Darkvision", "Enhance Ability", "Find Traps", "Gust of Wind", "Healing Spirit", "Lesser Restoration", "Locate Animals or Plants", "Locate Object", "Magic Weapon", "Pass Without Trace", "Protection from Poison", "Silence", "Spike Growth", "Summon Beast"],
    3: ["Ashardalon's Stride", "Conjure Animals", "Conjure Barrage", "Daylight", "Elemental Weapon", "Flame Arrows", "Flame Stride (UA)", "Lightning Arrow", "Meld into Stone", "Nondetection", "Plant Growth", "Protection from Energy", "Revivify", "Speak with Plants", "Summon Fey", "Water Breathing", "Water Walk", "Wind Wall"],
